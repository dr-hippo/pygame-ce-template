...
window = pygame.display.set_mode(cfg.RESOLUTION)
clock = pygame.time.Clock()
# font = utils.load_font(None, size=48, align=pygame.FONT_RIGHT, underline=True)
...
async def main():
    ...
    while True:
        ...
        window.fill("grey")
        # window.blit(img, (0, 0))
        # utils.render_text("Hello world. This is a Pygame template.",
